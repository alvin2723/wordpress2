...
class CP_AppBookingPlugin extends CP_APPBOOK_BaseClass {
    ...
    function insert_public_item() {
        ...
        if (CP_APPBOOK_DEFER_SCRIPTS_LOADING)
        {
            ...
            wp_enqueue_script( $this->prefix.'_builder_script',
               $this->get_site_url( false ).'?cp_cpappb_resources=public',array("jquery","jquery-ui-core","jquery-ui-datepicker","jquery-ui-widget","jquery-ui-position","jquery-ui-tooltip","jquery-ui-dialog"), false, true );  
    ...
    function gutenberg_block() {
        ...
        wp_enqueue_script( $this->prefix.'_builder_script',
               $this->get_site_url( false ).'?cp_cpappb_resources=public',array("jquery","jquery-ui-core","jquery-ui-datepicker","jquery-ui-widget","jquery-ui-position","jquery-ui-tooltip"), false, true ); 
