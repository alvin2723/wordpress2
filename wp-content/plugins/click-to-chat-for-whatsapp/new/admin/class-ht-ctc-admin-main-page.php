...
class HT_CTC_Admin_Main_Page {
    ...
    function ctc_desktop_style_cb() {
        ...
        <p class="description"> Can customize the styles   ( Click to Chat -> <a style="color: #ff00b1;" target="_blank" href="<?php echo admin_url( 'admin.php?page=click-to-chat-customize-styles' ); ?>">Customize Styles )</a> </p> -->
        <?php
    }   
    ...
    function ctc_mobile_style_cb() {
        ...
        <p class="description"> - <a target="_blank" href="https://www.holithemes.com/plugins/click-to-chat/list-of-styles/">List of syles</a> </p>
        <p class="description"> Can customize the styles   ( Click to Chat -> <a target="_blank" href="<?php echo admin_url( 'admin.php?page=click-to-chat-customize-styles' ); ?>">Customize Styles</a> ) </p>
        <br>
        <?php
    }
    ...
    function ctc_show_hide_cb() {
        ...
        <span class="description">Show/Hide:</span>
